class SymbolExtension
  ...
  @@head : UInt64 = (:SymbolExtension.unsafe_as(Pointer(Void)).address&0xffffffff00000000)+0xFFFFFFFF
...
struct Symbol
  def to_s
    (to_i < 0 ? SymbolExtension.to_s(self) : previous_def).not_nil!
  end
